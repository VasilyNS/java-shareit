...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveRequest(Long userId, RequestDtoIn requestDtoIn) {
        Validator.requestValidation(requestDtoIn);
        return post("", userId, requestDtoIn);
    }

    public ResponseEntity<Object> getRequestsOwn(Long userId) {
        return get("", userId);
    }

    public ResponseEntity<Object> getRequestsAll(Long userId, Long from, Long size) {
